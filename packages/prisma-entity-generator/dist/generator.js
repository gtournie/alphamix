...
exports.PrismaEntityGenerator = exports.PrismaEntityGeneratorOptions = exports.GENERATOR_NAME = void 0;
...
exports.PrismaEntityGeneratorOptions = {
    makeIndexFile: {
    ...
    constructor(options) {
        this.run = async () => {
            ...
            files.forEach((fileRow) => {
                fileRow.imports.push(new import_component_1.ImportComponent((0, util_1.getRelativeTSPath)(indexFilePath, indexFilePath), "Entity"));
            ...
            if (config.makeIndexFile) {
                ...
                const content = index_template_1.INDEX_TEMPLATE.replace('#!{IMPORTS}', imports.map((i) => i.echo()).join('\r\n'))
        ...
        this.getConfig = () => {
            ...
            const result = {};
            for (const optionName in exports.PrismaEntityGeneratorOptions) {
                const { defaultValue } = exports.PrismaEntityGeneratorOptions[optionName];
...
exports.PrismaEntityGenerator = PrismaEntityGenerator;
