...
#### 2a. Color contrast (`color-contrast`)
...
#### 2b. Discernible names (`button-name`, `aria-input-field-name`, `label`, `select-name`, `aria-progressbar-name`)
...
#### 2c. Nested interactive (`nested-interactive`)
...
#### 2d. Landmark rules (`landmark-banner-is-top-level`, `landmark-unique`, `landmark-no-duplicate-banner`)
...
#### 2e. ARIA prohibited attributes (`aria-prohibited-attr`)
...
#### 2f. Scrollable regions (`scrollable-region-focusable`)
...
#### 2g. Definition lists (`definition-list`)
...
#### 2h. Empty table headers (`empty-table-header`)
