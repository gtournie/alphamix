				...
				<Command.Root>
					...
					<Command.List>
						...
						<Command.Group heading="Suggestions">
							...
							<Command.Item value="search-emoji">
								<SmileIcon />
...
<Story name="Shortcuts">
	{#snippet template()}
		<div class="flex flex-col gap-4">
			<Button onclick={() => (shortcutsOpen = true)} variant="outline" class="w-fit">
				Open Menu
			</Button>
			<Command.Dialog bind:open={shortcutsOpen}>
				<Command.Input placeholder="Type a command or search..." />
				<Command.List>
					<Command.Empty>No results found.</Command.Empty>
					<Command.Group heading="Settings">
...
<Story name="Groups">
	{#snippet template()}
		<div class="flex flex-col gap-4">
			<Button onclick={() => (groupsOpen = true)} variant="outline" class="w-fit">
				Open Menu
			</Button>
			<Command.Dialog bind:open={groupsOpen}>
				<Command.Input placeholder="Type a command or search..." />
				<Command.List>
					<Command.Empty>No results found.</Command.Empty>
					<Command.Group heading="Suggestions">
...
<Story name="Scrollable">
	{#snippet template()}
		<div class="flex flex-col gap-4">
			<Button onclick={() => (scrollableOpen = true)} variant="outline" class="w-fit">
				Open Menu
			</Button>
			<Command.Dialog bind:open={scrollableOpen}>
				<Command.Input placeholder="Type a command or search..." />
				<Command.List>
					<Command.Empty>No results found.</Command.Empty>
					<Command.Group heading="Navigation">
						...
						<Command.Item value="documents">
							<FileTextIcon />
							<span>Documents</span>
							<Command.Shortcut>⌘D</Command.Shortcut>
						</Command.Item>
						<Command.Item value="folders">
							<FolderIcon />
							<span>Folders</span>
					...
					<Command.Group heading="View">
						<Command.Item value="grid-view">
							<LayoutGridIcon />
							<span>Grid View</span>
						</Command.Item>
						<Command.Item value="list-view">
							<ListIcon />
							<span>List View</span>
						</Command.Item>
						<Command.Item value="zoom-in">
							<ZoomInIcon />
							<span>Zoom In</span>
							<Command.Shortcut>⌘+</Command.Shortcut>
						</Command.Item>
						<Command.Item value="zoom-out">
							<ZoomOutIcon />
							<span>Zoom Out</span>
							<Command.Shortcut>⌘-</Command.Shortcut>
						</Command.Item>
					...
					<Command.Group heading="Tools">
						<Command.Item value="calc-tool">
							<CalculatorIcon />
							<span>Calculator</span>
						</Command.Item>
						<Command.Item value="calendar-tool">
							<CalendarIcon />
							<span>Calendar</span>
						</Command.Item>
